      ...
      <div id="main">
        ...
        <form
          ...
          <div className="form-header">
            <div className="form-img" style={{ padding: 0 }}>
              <svg className='logo-img' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                <defs>
              ...
              {/* <img className='logo-img' id="image" src='assets/img/logo-login.svg' alt="SoDe World" /> */}
            </div>
            <h2 className='form-title'>Atalaya</h2>
